define(['can/util/can'], function (can) {
    // Get the URL from old require root, new require config or can.fixture.rootUrl
    var getUrl = function (url) {
        if (typeof require !== 'undefined') {
            var root = [require.s.contexts["_"].config["baseUrl"]];
            return root.join(url).toString();
        }
    ...
    var updateSettings = function (settings, originalOptions) {
            ...
            var _logger = function (type, arr) {
                ...
                log = function () {
                    if (typeof can !== 'undefined' && can.dev) {
            ...
            if (typeof settings.fixture == "string") {
                ...
                if (/^\/\//.test(url)) {
                    // this lets us use rootUrl w/o having require...
                ...
                if ("localhost" != document.domain) {
                    try {
                        if (null == settings.fixture(null, function () {
                        })) {
                            return;
                        }
                    }
     ...
     *
     * @codestart
     * require('can/util/fixtures').then(function(){
     ...
     * If you are using require it will use the require root
     * URL by default.
     */
