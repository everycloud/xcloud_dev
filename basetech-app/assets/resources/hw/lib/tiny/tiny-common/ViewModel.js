define(["tiny-lib/Class", "tiny-lib/jquery", "tiny-lib/underscore", "tiny-widgets/common"], function(Class, $, _, common) {
    ...
    //TODO: 在构造函数中自动处理： 所有不是以 _开头的函数，自动调用  updateBindingView()
    var ViewModel = Class.extend({
        ...
        "bindView" : function() {
            ...
            //定义绑定模块
            angular.module(moduleName, modelThis.dependentAngularModules || []).controller(controllerName, ["$scope", _.bind(controllerFn, null, modelThis)]);
