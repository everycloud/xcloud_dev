define(["tiny-directives/Directive", "tiny-widgets/Select"], function(Directive, SelectWidget) {

    var DEFAULT_CONFIG = {
        "directiveName" : "tinySelect",
        ...
        "constantProperties" : ["mode", "showTip", "validate", "tooltip", "tipWidth", "isvalidtip", "errorMsg", "extendFunction"],
        "template" : "<span></span>",
        "replace" : "true"
    };
