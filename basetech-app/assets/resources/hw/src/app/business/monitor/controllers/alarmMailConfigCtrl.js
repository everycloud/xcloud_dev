define(['jquery',
...
], function ($, angular, TextBox, Button, Window, Checkbox, Message, ExceptionService, performanceService, CommonService, UnifyValid, ValidatorService, cloudInfraService) {
    "use strict";
    ...
    var alarmMailConfigCtrl = ["$scope", "$compile", "$state", "camel", "$q", '$stateParams',
        function ($scope, $compile, $state, camel, $q, $stateParams) {
            ...
            var user = $scope.user;
            var i18n = $scope.i18n;
            $scope.hasAlarmEmailOperateRight = _.contains(user.privilegeList, "106002");
            $scope.address = {
                "id": "alarmAddress",
            ...
            $scope.searchMailAlarmBox = {
                ...
                "placeholder":  $scope.i18n.common_term_findAlarmName_prom,
                "width": "200",
                "suggest-size": 10,
                "maxLength": 64,
            ...
            function remove(id) {
                ...
                var promise = performanceServiceIns.deleteReceiveConfig(options);
            ...
            function insert() {
                ...
                var promise = performanceServiceIns.addReceiveConfig(options);
            ...
            function update() {
                ...
                var info = createRecipientAlarmInfo();
                var options = {
                    "user": user,
                    "recipients": info,
                    "id": info.recipientId,
                ...
                var promise = performanceServiceIns.modifyReceiveConfig(options);
                promise.then(function (data) {
                    getData();
                    $scope.showWin = false;
                    $scope.showMailViewWin = false;
            ...
            $scope.dataGridViewTable = {
                ...
                "renderRow": function (nRow, aData, iDataIndex) {
                    ...
                    if ($scope.hasAlarmEmailOperateRight) {
                        optColumn = optColumn + " <a href='javascript:void(0)' ng-click='modify()'>" + $scope.i18n.common_term_modify_button + "</a>&nbsp;&nbsp;" + " <a href='javascript:void(0)' ng-click='deleter()'>" + $scope.i18n.common_term_delete_button + "</a>";
                    }
            ...
            function initRecipientAlarmInfo(id, mode) {
                ...
                var options = {
                    ...
                    "id": id,
                    "cloudInfraId": cloudInfraId,
                    "locale": ($("html").scope().urlParams.lang == "zh" ?"zh_CN" : "en_US")
                };
                var promise = performanceServiceIns.sendEmailDetail(options);
                promise.then(function (data) {
                    $scope.mode = mode;
            ...
            function getData() {
                ...
                var promise = performanceServiceIns.queryEmailConfigDetail(options);
                promise.then(function (data) {
                    if (!data) {
                        return;
                    }
                    data = performanceServiceIns.getRecipientsGridViewData(data);
                    $scope.dataGridViewTable.totalRecords = data.total;
                    $scope.dataGridViewTable.data = data.recipients;
                });
            }
            ...
            function getUserData() {
                ...
                performanceServiceIns.getUsersInfo(
            ...
            function getQueryDefineAlarmJsonInfo() {
                ...
                $scope.reqDefineParams.locale = ($("html").scope().urlParams.lang == "zh" ?"zh_CN" : "en_US");
            }

            function getDefineAlarmData() {
                getQueryDefineAlarmJsonInfo();
                performanceServiceIns.getDefineAlarmInfo(
