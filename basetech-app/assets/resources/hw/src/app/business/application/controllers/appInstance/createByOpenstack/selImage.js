...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService) {
        ...
        var selImageModule = angular.module("app.createByOpenstack.selImage", ['framework','ngSanitize']);
        selImageModule.controller("app.createByOpenstack.selImage.ctrl", configParamCtrl);
