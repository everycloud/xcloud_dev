            ...
            mxEvent.addListener(this.imageNode, 'click',
                mxUtils.bind(this, function (evt) {
                    if (this.style.type === "VmTemplate") {
                        ...
                        if (isVml) {
                            this.imageNode.src = "/resources/hw/theme/default/images/designerbone-add-scalinggroup.png";
                        } else {
                            this.imageNode.setAttribute("href", "/resources/hw/theme/default/images/designerbone-add-scalinggroup.png");
                        }
                    }
                    this.redraw();
                    mxEvent.consume(evt);
