...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService, cloudInfraService) {
            ...
            function ($scope, $compile, camel, exception, $q) {
                ...
                $scope.azTable = {
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApprovalAppChooseAzRadioId";
                        selBoxScope.id = "appApprovalAppChooseAzRadioId" + iDataIndex;
        ...
        var selAzModule = angular.module("ssp.approvalByOpenstack.selAz", ['framework','ngSanitize']);
        selAzModule.controller("ssp.approvalByOpenstack.selAz.ctrl", configParamCtrl);
