...
define(['jquery',
    ...
    var chooseVlbCtrl = ["$scope", "$compile", "camel", "$state", "exception", "$q",
        function ($scope, $compile, camel, $state, exception, $q) {
            ...
            var i18n = $scope.i18n;
            $scope.selVlbData = $("#approvalAppChooseVlbSel1").widget().option("selVlbData");
            $scope.vpcId = $("#approvalAppChooseVlbSel1").widget().option("vpcId");
            $scope.cloudInfraId = $("#approvalAppChooseVlbSel1").widget().option("cloudInfraId");
            ...
            $scope.availableVlbs = {
                "id": "approvalAppChooseVlbAvailabeVlbs",
                "draggable": true,
                "displayLength": 10,
                "totalRecords": 0,
                ...
                "renderRow": function (nRow, aData, iDataIndex) {
                    ...
                    selBoxScope.name = "approvalAppChooseVlbRadioName";
                    selBoxScope.id = "approvalAppChooseVlbRadioId" + iDataIndex;
                    ...
                    selBoxScope.change = function (vlbName) {
                        $scope.tmpSelectedVlbId = $("#approvalAppChooseVlbRadioId0").widget().opChecked();
    ...
    var chooseVlbModule = angular.module("app.approval.chooseVlb", ["framework", "ngSanitize"]);
    chooseVlbModule.controller("app.approval.chooseVlb.ctrl", chooseVlbCtrl);
