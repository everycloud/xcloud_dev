    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, networkService) {
        ...
        var configParamCtrl = ["$scope", "$compile", "camel", "exception", "appCommonData", "$q",
            function ($scope, $compile, camel, exception, appCommonData, $q) {
                ...
                $scope.ictNetworkType = "VPCNET";    // ICT������Ҫ���VPC�����ֱ������
                var page = {
                    "currentPage": 1,
                    "displayLength": 10,
                    "getStart": function () {
        ...
        var selImageModule = angular.module("ssp.createByOpenstack.selNetwork", ['framework', 'ngSanitize']);
        selImageModule.controller("ssp.createByOpenstack.selNetwork.ctrl", configParamCtrl);
