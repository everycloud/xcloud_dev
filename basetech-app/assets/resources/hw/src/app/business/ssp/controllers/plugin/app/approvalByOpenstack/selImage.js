...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService) {
            ...
            function ($scope, $compile, camel, exception, $q) {
                ...
                $scope.imageTable = {
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApprovalAppChooseImageRadioId";
                        selBoxScope.id = "appApprovalAppChooseImageRadioId" + iDataIndex;
        ...
        var selImageModule = angular.module("ssp.approvalByOpenstack.selImage", ['framework','ngSanitize']);
        selImageModule.controller("ssp.approvalByOpenstack.selImage.ctrl", configParamCtrl);
