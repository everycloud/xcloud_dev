...
define(["sprintf",
    ...
    var catalogCtrl = ["$rootScope", "$scope", "$state", "$stateParams", "$compile", "$q", "camel", "exception",
        function ($rootScope, $scope, $state, $stateParams, $compile, $q, camel, exception) {
            ...
            //搜索框中的字符串
            $scope.searchString = instanceId?instanceId:"";
            $scope.status = "";
            ...
            // 按状态过滤
            $scope.searchStatus = {
                id: "allServiceMyServiceSearchStatus",
                width: "200",
                "values": [{
                    selectId: "",
                ...
                "change": function () {
                    page.currentPage = 1;
                    $scope.status = $("#" + $scope.searchStatus.id).widget().getSelectedId();
            ...
            // 搜索框
            $scope.searchBox = {
                "id": "allServiceMyServiceSearchBox",
            ...
            $scope.help = {
                "helpKey": "drawer_sc_all_instance",
                "show": false,
            ...
            $scope.myServices = {
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "mData": function (data) {
                            return $.encoder.encodeForHTML(data.applyUserName);
                        },
                        "bSortable": false
                    }, {
                ...
                "renderRow": function (nRow, aData, iDataIndex) {
                    ...
                    if (aData.status === "normal" || aData.status === "expired") {
                        ...
                        $("td[tdname='7']", nRow).append(optNode);
                    }
                }
            };
