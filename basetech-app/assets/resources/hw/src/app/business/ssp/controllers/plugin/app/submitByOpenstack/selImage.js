...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService) {
            ...
            function ($scope, $compile, camel, exception, $q) {
                ...
                $scope.imageTable = {
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApplyAppChooseImageRadioId";
                        selBoxScope.id = "appApplyAppChooseImageRadioId" + iDataIndex;
        ...
        var selImageModule = angular.module("ssp.applyByOpenstack.selImage", ['framework','ngSanitize']);
        selImageModule.controller("ssp.applyByOpenstack.selImage.ctrl", configParamCtrl);
