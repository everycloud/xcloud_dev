...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService) {
        ...
        var configParamCtrl = ["$scope", "$compile", "camel", "exception", "$q",
            function ($scope, $compile, camel, exception, $q) {
                ...
                $scope.instanceTypeTable = {
                    "id": "apply-app-instanceTypeTable",
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApplyAppChooseInstanceTypeRadio";
                        selBoxScope.id = "appApplyAppChooseInstanceTypeRadio" + iDataIndex;
        ...
        var selImageModule = angular.module("ssp.applyByOpenstack.selInstanceType", ['framework','ngSanitize']);
        selImageModule.controller("ssp.applyByOpenstack.selInstanceType.ctrl", configParamCtrl);
