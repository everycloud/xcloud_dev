...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService) {
        ...
        var selImageModule = angular.module("ssp.createByOpenstack.selInstanceType", ['framework','ngSanitize']);
        selImageModule.controller("ssp.createByOpenstack.selInstanceType.ctrl", configParamCtrl);
