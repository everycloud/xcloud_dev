        ...
        var ctrl = ["$scope", "$compile", "$q", "camel", "networkCommon", "exception",
            function ($scope, $compile, $q, camel, networkCommon, exception) {
                ...
                $scope.searchRuleType = {
                    "id": "networkACLsAclsinSelectRuleType",
                    "width": "120",
                    "values": [
                        {
                            "selectId": "1",
                    ...
                    "change": function () {
                        ...
                        $scope.aclsInTable.columns = getColumns();
                        //页码置1
                        page.currentPage = 1;
                        $scope.command.queryFirewallRule();
                    }
                ...
                $scope.searchProtocolType = {
                    "id": "networkACLsAclsinSearchProtocolType",
                    "width": "120",
                    "values": [
                        {
                            "selectId": "",
                ...
                $scope.command = {
                    ...
                    "queryFirewallRule": function () {
                        ...
                        deferred.then(function (data) {
                            ...
                            $scope.aclsInTable.data = firewallRulesRes;
                            $scope.aclsInTable.totalRecords = data.total;
                            $scope.aclsInTable.displayLength = page.displayLength;
                            $("#" + $scope.aclsInTable.id).widget().option("cur-page", {
