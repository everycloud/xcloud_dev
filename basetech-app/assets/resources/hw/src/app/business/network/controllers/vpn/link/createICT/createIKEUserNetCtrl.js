define([
	...
	"use strict";
	var ctrl = ["$scope", "camel", "$compile", function ($scope, camel, $compile) {
			var i18n = $scope.i18n;
			...
			$scope.info = {
				...
				mark : {
					...
					"value" : "",
					"extendFunction" : ["isIPv4Check"],
					validate : "required:" + i18n.common_term_null_valid + ";isIPv4Check(create-link-userIke-mark):" + i18n.common_term_formatIP_valid,
					"type" : "ipv4"
				},
				wayPwdChangeBox : {
					"label" : "",
