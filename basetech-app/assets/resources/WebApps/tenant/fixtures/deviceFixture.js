define(["can/util/fixture/fixture"], function (fixture) {
    ...
    var loadBalance = {"code": "0", "message": "", "total": 1, "url": null, "lbList": [
        {"rid": "10737", "deviceId": 10737, "deviceName": "VLB_A01", "deviceIp": "192.168.5.230",
            "peerIp": null, "zoneName": "ZONE_XIAN", "roomName": "xianRoom01", "rackName": "xianRack01", "subRackName": "xianRack01_1",
        ...
        {"protocol": 3, "port": 443, "userName": "admin", "passWord": "admin", "timeOut": 0},
            "snmpPara": {"snmpVersion": 1, "snmpPort": 161, "readCommunity": "public", "writeCommunity": "private",
    ...
    fixture({
        ...
        "GET /goku/rest/v1.5/irm/fusionstorage": function (original, response) {
            var result =
            {"code":"0","message":"","fsConnectorInfos":[{"id":"233sfdfsdf","ip":"192.168.60.3",    "userName":"gmadmin",   "name":"sswre1",  "port":"443"} ]}
