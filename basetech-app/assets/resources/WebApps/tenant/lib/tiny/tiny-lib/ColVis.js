...
ColVis.prototype = {
    ...
    "_fnConstruct": function ()
    {
        ...
        $(this.dom.button).attr("title","Set Columns Visibility");
    ...
    "_fnDrawCallback": function ()
    {
        ...
        for ( var i=0, iLen=aoColumns.length ; i<iLen ; i++ )
        {
            if ( this.dom.buttons[i] !== null )
            {
                ...
                {
                    $('span.ColVis_radio', this.dom.buttons[i]).removeClass("Radio_unchecked").addClass("Radio_checked");
                }
                else
                {
                    $('span.ColVis_radio', this.dom.buttons[i]).removeClass("Radio_checked").addClass("Radio_unchecked");
                }
            }
        }
    },
    ...
    "_fnDomColumnButton": function ( i )
    {
        var
            ...
            nSpan = document.createElement('span'),
            dt = this.s.dt;
        nButton.style.width = "auto";
        nSpan.style.width = "auto";
        ...
        $(nSpan).html(
            ...
            '<span class="ColVis_radio Radio_checked"></span>'+
            '<span class="ColVis_title">'+sTitle+'</span>' );
        
        $(nButton).click( function (e) {
            
            var $radioBtn = $('span.ColVis_radio', this);
            var showHide = $radioBtn.hasClass("Radio_checked");
            if(!showHide){
            $radioBtn.removeClass("Radio_unchecked").addClass("Radio_checked");
            }else{
            $radioBtn.removeClass("Radio_checked").addClass("Radio_unchecked");    
            }
            showHide = !showHide;
    ...
    "_fnDomBackground": function ()
    {
        ...
        $("div.tiny-layout-west, #tiny-menu").click( function () {
            that._fnCollectionHide.call( that, null, null );
        } );
    ...
    "_fnCollectionShow": function ()
    {
        ...
        if ( !this.s.bCssPosition )
        {
            nHidden.style.left = this.s.sAlign=="left" ?
                iDivX+"px" : (iDivX-$(nHidden).outerWidth()+$(this.dom.button).outerWidth()+10)+"px";
