( function($, undefined) {
        ...
        $.widget("ui.dialog", {
            ...
            _createTitlebar : function() {
                ...
                this.uiDialogTitlebarClose = $('<a href="javascript:void(0)"></a>').addClass('ui-dialog-titlebar-close ' + 'ui-corner-all').attr('role', 'button').hover(function() {
                ...
                $('<span></span>').addClass('ui-icon ' + 'ui-icon-closethick').text(this.options.closeText).appendTo(this.uiDialogTitlebarClose);
            ...
            _createButtons : function() {
                ...
                $.each(buttons, function(name, props) {
                    var buttonClass = "tiny-button-buttonDefault tiny-button-buttonClass";
                    ...
                    if (props.focused && "message" == props.containerType) {
                        buttonClass += " tiny-button-focus major-btn";
                    }
                    if (props.majorBtn) {
                        buttonClass += " major-btn";
                    }   
                    var button = $('<a href="javascript:void(0)" class="' + buttonClass + '" accessKey=' + props.accessKey + '><div class="tiny-button tiny-button-buttonInnerClass"><div class="tiny-right"><div class="tiny-center"><div class="tiny-leftImg" style="display: none;"></div><span class="tiny-button-buttonCenterText">' + props.text + '</span><div class="tiny-rightImg" style="display: none;"></div></div></div></div></a>').click(function() {
                        props.click.apply(that.element[0], arguments);
                    }).mouseover(function() {
                        $(this).addClass("tiny-button-hover");
                        $(this).removeClass("tiny-button-focus");
                    }).mouseout(function() {
                        ...
                        $(this).removeClass("tiny-button-hover");
                        $(this).removeClass("tiny-button-focus");
                        $(this).addClass("tiny-button-active");
                    }).mouseup(function() {
                        $(this).removeClass("tiny-button-active");
                        $(this).removeClass("tiny-button-focus");
            ...
            _size : function() {
                ...
                if (options.height === "auto") {
                    ...
                    this.element.height(Math.max(0, options.height - nonContentHeight + 60));
                }
                        ...
                        if ($.ui.dialog.overlayInstances) {
                            this.document.bind("focusin.dialog", function(event) {
                                if (!that._allowInteraction(event)) {
                                    event.preventDefault();
                                    //解决tiny bug#39 弹出窗中的tiny-datetime的时分秒的输入框无法编辑问题,删除window框中自动设置焦点代码
                                }
                            });
                        }
                    });
