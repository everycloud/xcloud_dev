...
define([
    ...
    function (sprintf, $, angular, ngSanitize, keyIDI18n,http, constants, Window, UnifyValid, messageService, _) {
        "use strict";
        ...
        var configParam = angular.module("app.create.configShell", ['framework']);
