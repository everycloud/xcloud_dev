...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService, cloudInfraService) {
        ...
        var selAzModule = angular.module("app.createByOpenstack.selAz", ['framework','ngSanitize']);
        selAzModule.controller("app.createByOpenstack.selAz.ctrl", configParamCtrl);
