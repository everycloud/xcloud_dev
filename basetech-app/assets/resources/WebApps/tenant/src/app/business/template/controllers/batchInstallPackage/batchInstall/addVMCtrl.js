...
define(['jquery',
    ...
    "use strict";
    var ctrl = ["$rootScope", "$scope", "monkey", "$compile", "camel", "$q", "$stateParams",
        function ($rootScope, $scope, monkey, $compile, camel, $q, $stateParams) {
            //存储当前已选择的告警
            $scope.checkboxData = [];
            ...
            $scope.vmTableList = {
                ...
                "callback": function (evtObj) {
                    var displayLength = $("#vmListTable").widget().option("display-length");
