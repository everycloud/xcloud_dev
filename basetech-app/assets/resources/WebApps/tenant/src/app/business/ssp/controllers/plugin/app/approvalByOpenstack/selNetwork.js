...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, networkService) {
            ...
            function ($scope, $compile, camel, exception, appCommonData, $q) {
                ...
                $scope.networkTable = {
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApprovalAppChooseNetworkRadio";
                        selBoxScope.id = "appApprovalAppChooseNetworkRadio" + iDataIndex;
                ...
                $scope.nextBtn = {
                    ...
                    "click": function () {
                        $scope.curParamTableData.value = $("#approval-app-subnetselect").widget().getSelectedLabel();
                        $scope.curParamTableData.selectId = $("#approval-app-subnetselect").widget().getSelectedId();
        ...
        var selImageModule = angular.module("ssp.approvalByOpenstack.selNetwork", ['framework','ngSanitize']);
        selImageModule.controller("ssp.approvalByOpenstack.selNetwork.ctrl", configParamCtrl);
