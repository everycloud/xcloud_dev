define([
    ...
    "fixtures/appFixture"
], function ($, $jBase, Constant, $rs, OS, _, desigerService, constants, CoreGraph, Sidebar, UnifyValid, Window) {
    "use strict";
    ...
    var ctrl = ["$rootScope", "$window","$scope", "$compile", "exception", "$q", "camel", "message", "$timeout", "$state", "$stateParams",
        function ($rootScope, $window, $scope, $compile, exception, $q, camel, message, $timeout, $state, $stateParams) {
            ...
            var i18n = $scope.i18n;
            $scope.hasOperateAppTempRight = _.contains($rootScope.user.privilegeList, constants.privileges.OPERATE_APP_TEMPLATE);
            $scope.graph = graph;
            //左侧栏
            ...
            $scope.elements = {
                ...
                template: {
                    ...
                    "title": i18n.common_term_vms_label
                },
                software: {
                    "src": "../theme/default/images/icon-software.png",
                    "title": i18n.common_term_software_label
                },
                script: {
                    "src": "../theme/default/images/icon-script.png",
                    "title": i18n.template_term_script_label
                }
            };
            //左侧栏结束
