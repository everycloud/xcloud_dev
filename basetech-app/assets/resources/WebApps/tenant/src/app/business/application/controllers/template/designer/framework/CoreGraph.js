define(["./Graph", "./mxVertexToolHandler", "./GenenalNameUtil"], function (Graph, mxVertexToolHandler, GenenalNameUtil) {
    ...
    CoreGraph.prototype.addTemplateNodeOverlayStyle = function (templateCell) {
        ...
        //操作系统的图标
        var osType = "Windows";
        var image = "../theme/default/images/icon-vm.png";
        ...
        var ScalingGroup = "../theme/default/images/designerbone-del-scalinggroup.png";
        var VmTemplate = "../theme/default/images/designerbone-add-scalinggroup.png";
