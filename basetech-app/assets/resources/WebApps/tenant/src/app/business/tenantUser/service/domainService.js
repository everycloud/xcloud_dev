    ...
    var service = function () {
        this.initTree = function (domainList, selectedDomainId) {
            ...
            for (var index in domainList) {
                ...
                var node = {
                    "id": domainList[index].domainId,
                    "pId": "domainParentId",
                    "name": domainList[index].domainName,
                    "icon": "../theme/default/images/gm/domain.png",
                    "selected": domainList[index].domainId == selectedDomainId,
                    "hasPrivelegeOnDomain":domainList[index].hasPrivelegeOnDomain
                };
                treeData.push(node);
            }
            return treeData;
