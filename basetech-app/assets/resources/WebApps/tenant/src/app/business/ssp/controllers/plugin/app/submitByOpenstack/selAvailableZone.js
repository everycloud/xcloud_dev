...
define([
    ...
    function (sprintf, $, encoder, angular, ngSanitize, keyIDI18n, http, Window, _, UnifyValid, appCommonService, cloudInfraService) {
            ...
            function ($scope, $compile, camel, exception, $q) {
                ...
                $scope.azTable = {
                    ...
                    "renderRow": function (nRow, aData, iDataIndex) {
                        ...
                        selBoxScope.name = "appApplyAppChooseAzRadioId";
                        selBoxScope.id = "appApplyAppChooseAzRadioId" + iDataIndex;
        ...
        var selAzModule = angular.module("ssp.applyByOpenstack.selAz", ['framework','ngSanitize']);
        selAzModule.controller("ssp.applyByOpenstack.selAz.ctrl", configParamCtrl);
