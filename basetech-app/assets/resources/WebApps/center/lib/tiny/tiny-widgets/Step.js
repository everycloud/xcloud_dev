...
define(["tiny-lib/angular","tiny-lib/underscore", "tiny-lib/jquery", "tiny-lib/Class", "tiny-widgets/Widget", "tiny-lib/encoder"], function(angular,_, $, Class, Widget, encoder) {
    ...
    var Step = Widget.extend({
        ...
        "_generateElement" : function() {
            ...
            widgetThis.oStep = widgetElement;
        ...
        "_reRender" : function() {
            ...
            var linkWidth = (widgetThis.width - totalNodes * 26) / (totalNodes - 1);
            var remNodeImage;
            var remNodeData;
            ...
            for (var i = 0; i < totalNodes; i++) {
                ...
                nodeDatas[i] = $.encoder.encodeForHTML(nodeDatas[i] + "");
                remNodeData[0].innerHTML = nodeDatas[i];
                if (widgetThis.disable === true) {
                    remNodeData.css({
                        'color' : '#c7c7c7'
                    });
