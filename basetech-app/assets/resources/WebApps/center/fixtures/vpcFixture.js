define(["can/util/fixture/fixture"], function (fixture) {
    ...
    fixture({
        ...
        "POST /goku/rest/v1.5/irm/{vdc_id}/networks": function (original, response) {
            ...
            var net =
            {
                "networkID": Math.ceil(Math.random()*100000000000).toString(),
                "vpcId": Math.ceil(Math.random()*10000).toString(),
                "azID":Math.ceil(Math.random()*10000).toString(),
                "vdcID": Math.ceil(Math.random()*10000).toString(),
                ...
                "totalBoundNics": 0,
                "snat": null,
                "vpcName": "sharedVPC_A02",
                "shareVpc": true,
                "azName": "shenzhen_AZ01"

            };

            networkList.networks.push(net);
            response(200, "success", {}, {});
        },
