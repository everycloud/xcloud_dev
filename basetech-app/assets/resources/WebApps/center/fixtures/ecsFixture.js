define(["can/util/fixture/fixture",
    ...
    var configTemplates = [
        {
            ...
            slaLabels: [{labelKey:"SLA", labelValue:"GOLD"}],
            qos: {},
            systemDiskSize: 10
        },
        {
            ...
            slaLabels: [{labelKey:"SLA", labelValue:"SILVER"}],
            qos: {},
            systemDiskSize: 20
        },
        {
    ...
    var hosts = [
        {
            ...
            status: "运行中",
            ip: "192.168.40.159",
            model: "RH2285/2个CPU/32GB/11988GB",
            os: "Redhat Linux 6.2",
            config: "2个CPU/32GB/11988GB",
            az: "深圳",
    ...
    fixture({
        ...
        "POST /goku/rest/v1.5/{vdc_id}/vpcs/{vpc_id}/vms/action?cloud-infra={cloud_infra_id}": function (original, response) {
            ...
            for (var i = start; i < start + limit; i++) {
                var vm = {
                    ...
                    "rid": "vm-rid-" + i,
                    "resourcePoolId": "cloudInfra01",
                    "name": i % 2 ? "windows_2003_vmware01" : "linux_vmware02",
        ...
        "GET /goku/rest/v1.5/{vdc_id}/available-zones/{id}/tags": function (original, response) {
            var ret = {
                "resourceCluster":[{"name":"SLA","value":"SILVER"},{"name":"SLA","value":"GOLD"},{"name":"SLA","value":"COPPER"}],
                "common":[{"name":"SLA","value":"GOLD"}],
        ...
        //物理机查询
        "GET /goku/rest/v1.5/{vdc_id}/dedicatedServers?cloud-infra={cloud_infra_id}": function (original, response) {
        ...
        "GET /goku/rest/v1.5/{vdc_id}/vmProcessMonitor?vmId={vmId}&processId={processId}": function (original, response) {
        ...
        "GET /goku/rest/v1.5/{vdc_id}/vmProcessList?vmId={vmId}": function (original, response) {
