            ...
            function ($scope, $compile, $state, $stateParams, camel, $interval, $timeout, exception) {
                ...
                $scope.interruptConfirm = function (interruptEvent, toState, toParams) {
                    var msgOptions = {
                        ...
                        "content":$scope.i18n.template_script_cancleRestore_info_confirm_msg || "确实要取消修复该脚本吗？",
                        "width":"300",
                        "height":"200"
                    };
                ...
                $scope.uploadSuccessHandle = function () {
                    ...
                    var deferred = camel.post({
                        "url": {"s": constants.rest.SCRIPT_REPAIR.url, "o": {"tenant_id": 1, "scriptid": $stateParams.id}},
                        "params": JSON.stringify({"mainFilePath":"/" + $scope.service.uploadPath + "/" + $scope.service.model.repairFileName}),
                ...
                $scope.uploadErrorHandle = function(uploadStatus) {
                    ...
                    $timeout(function() {
                        $scope.$broadcast($scope.repairScriptEvents.updateProgress, uploadStatus);
                    }, 100);
                };
