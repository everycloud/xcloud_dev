...
define(['jquery',
    ...
    var bindVmCtrl = ["$scope", "camel",
        function ($scope, camel) {
            ...
            var window = $("#usbBindVmWindow").widget();
            var usbId = window.option("usbId");
            ...
            $scope.okButton = {
                ...
                "click": function () {
                    var data = $scope.bindVmTable.data;
                    var selectedVm;
                    var index = 0;
                    while ($("#vmRadio_" + index).widget()) {
    ...
    var bindVmModule = angular.module("resources.hostDetail.usbBindVm", ["ng"]);
    bindVmModule.service("camel", httpService);
    bindVmModule.controller("resources.hostDetail.usbBindVm.ctrl", bindVmCtrl);
    return bindVmModule;
});