define(["tiny-common/UnifyValid",
    "language/keyID",
    "sprintf"], function (UnifyValid, i18n, sprintf) {
    "use strict";
    UnifyValid.validateInfo = {
        "name": i18n.common_term_composition7_valid + i18n.sprintf(i18n.common_term_length_valid, 1, 256),
        "computerName": i18n.common_term_composition7_valid + i18n.sprintf(i18n.common_term_maxLength_valid, 256),
        "description": i18n.sprintf(i18n.common_term_maxLength_valid, 1024),
        "required": i18n.common_term_null_valid,
        "minimumSize": i18n.template_app_add_para_minflex_valid || "请输入1～200之间的整数,且最小值小于或者等于最大值。",
        "desiredCapacity": i18n.template_app_add_para_minflex_valid || "请输入1～200之间的整数,且最小值小于或者等于最大值。",
        "maximumSize": i18n.template_app_add_para_maxflex_valid || "请输入1～200之间的整数,且最大值大于或者等于最小值与最小运行虚拟机数。",
        ...
        "configP": i18n.sprintf(i18n.common_term_rangeInteger_valid, 1, 100),
        "configK": i18n.sprintf(i18n.common_term_rangeInteger_valid, 1, 1000000),
        "getName": function () {
    ...
    UnifyValid.computerName = function () {
        var element = this;
        var value = element.val();
        if ((!/^[\u4e00-\u9fa5A-Za-z0-9-_ ]*$/.test(value)) || value.length > 256) {
            return false;
        }
        return true;
    };
