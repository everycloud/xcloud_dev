...
define(['tiny-lib/jquery',
    ...
    "upload/jquery-form",
    "sprintf",
    "tiny-directives/FileUpload"], function ($, angular, ngSanitize, http, ExceptionService, message, userService, tipMessage, Message, jqueryForm, sprintf) {
    "use strict";
    var iconUploadCtrl = ['$scope', 'camel', '$window', "userService", "message", function ($scope, camel, $window, userService, message) {
        ...
        if ($windowDom && $windowDom.length) {
            ...
            $scope.iconUpload = {
                ...
                url: "/goku/rest/v1.5/1/service-icons",
