...
], function ($, angular, http, exception, orderService,catalogService, validatorService, UnifyValid) {
        "use strict";

        var addCatalogCtrl = ["$scope", "$q", "camel", "exception", function($scope, $q, camel, exception) {
            // 父窗口传递的参数
            ...
            $scope.catalogName = {
                "name" : (i18n.common_term_name_label||"目录名称")+":",
                "require" : true,
            ...
            $scope.catalogDesc = {
                "name" : (i18n.common_term_desc_label||"目录描述")+":",
                "require" : false,
