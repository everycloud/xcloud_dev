define(["tiny-lib/jquery","tiny-lib/encoder", "./resource",
    "language/keyID",
    "sprintf"], function ($, $encoder, $res, i18n, sprintf) {
    "use strict";
    var encoder = $.encoder;
    ...
    function alertCheckMessage(str) {
        ...
        switch (str) {
        case "IP":
            msg = i18n.common_term_errorIP_valid || "IP不正确";
            break;
        case "String":
            msg = i18n.common_term_noSpecialCharacter_valid || "不支持特殊字符";
            break;
        case "Integer":
