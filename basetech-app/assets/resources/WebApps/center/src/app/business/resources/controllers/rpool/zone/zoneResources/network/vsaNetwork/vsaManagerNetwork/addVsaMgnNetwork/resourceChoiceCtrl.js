        ...
        var resourceChoiceCtrl = ["$scope", "$state", "$stateParams", "camel", '$rootScope', "validator", function ($scope, $state, $stateParams, camel, $rootScope, validator) {
                ...
                $scope.nextBtn = {
                    ...
                    "click": function () {
                        ...
                        $scope.createInfo.subnetIP = $("#" + $scope.subnetIp.id).widget().getValue();
                        $scope.createInfo.subnetMask = $("#" + $scope.subnetMask.id).widget().getValue();
                        $scope.createInfo.subnetGateWay = $("#" + $scope.gateway.id).widget().getValue();
