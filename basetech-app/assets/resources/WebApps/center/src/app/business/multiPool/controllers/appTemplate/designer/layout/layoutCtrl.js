define([
    ...
    var ctrl = ["$rootScope", "$window","$scope", "$compile", "exception", "$q", "camel", "message", "$timeout", "$state", "$stateParams",
        function ($rootScope, $window, $scope, $compile, exception, $q, camel, message, $timeout, $state, $stateParams) {
            //公共对象
            ...
            $scope.hasPrivilege = $("html").scope().user.privilege["role_role_add_option_appTemplateHandle_value.312002"];
            ...
            $scope.elements = {
                network: {
                    ...
                    "title": $scope.i18n.vpc_term_net_label || "网络"
                },
                template: {
                    "src": "../theme/default/images/icon-vm.png",
                    "title": $scope.i18n.common_term_vm_label || "虚拟机"
                },
                software: {
                    "src": "../theme/default/images/icon-software.png",
                    "title": $scope.i18n.common_term_software_label || "软件"
                },
                script: {
                    "src": "../theme/default/images/icon-script.png",
                    "title": $scope.i18n.template_term_script_label || "脚本"
                }
            };
            //左侧栏结束
            ...
            $scope.initAppTemplate = function () {
                ...
                $scope.designerCell.icon.icon = "../theme/default/images/gm/appImage/" + icon;
            ...
            $scope.queryAppTemplate = function (id) {
                var deferred = $scope.serviceSrv.queryAppTemplate({
                    "tenantId": $scope.params.tenantId,
                    "userId": $scope.params.userId,
                    "id": id
                });
                deferred.then(function (data) {
                    $scope.graph.template.id = id;
                    if (!data) {
                        return;
                    }
                    $scope.graph.template.rebuildGraph(data.body, true, $scope.graph);
                    var deploys = $scope.graph.template.getParameters().properties;
                    var deploysValue = [];
                    for (var key in deploys) {
            ...
            $scope.createAppTemplate = function (options) {
                ...
                deferred.then(function (data) {
                    if (!data) {
                        message.failMsgBox($scope.i18n.common_term_createFail_value || "应用模板创建失败.");
                        return;
                    }
                    message.okMsgBox($scope.i18n.common_term_createSucceed_value || "应用模板创建成功.");
            ...
            $scope.updateAppTemplate = function (options) {
                ...
                deferred.then(function (data) {
                    message.okMsgBox($scope.i18n.app_term_templateUpdateSucceed_msg || "应用模板更新成功.");
                });
            };
            ...
            $scope.designerCell = {
                ...
                deploy: {
                    label: $scope.i18n.common_term_sharePara_label+":",
                    require: false
                },
                outputPrm: {
                    label: $scope.i18n.common_term_outputPara_label+":",
                    require: false
                },
                value: {
                    name: "",
            ...
            $scope.templateCell = {
                ...
                computerName: {
                    ...
                    width: "130px",
                    require: false,
                    "tooltip": UnifyValid.validateInfo.computerName,
                    "extendFunction": ["computerName"],
                    "validate": UnifyValid.validateInfo.getComputerName(),
                    blur: function () {
                ...
                transplantType: {
                    ...
                    "values": [
                        {
                            "selectId": "unSupport",
                            "label": $scope.i18n.common_term_notSupport_value || "不支持",
                            "checked": true
                        },
                        {
                            "selectId": "support",
                            "label": $scope.i18n.common_term_support_value || "支持"
                        }
                    ],
                    "change": function () {
                ...
                nics: {
                    label: $scope.i18n.common_term_NIClist_label+":",
                    require: false
                },
                initCommands: {
                    label: $scope.i18n.common_term_initializtionCmd_label + ":"
                },
                startCommands: {
                ...
                scalinggroup: {
                    "label": $scope.i18n.app_term_flexGroup_label+":",
                    "name": {
                    ...
                    "max": {
                        "id": "scalinggroup-max",
                        "label": $scope.i18n.app_term_vmMaxNum_label+":",
                        "width": "130px",
                        require: true,
                    ...
                    "min": {
                        "id": "scalinggroup-min",
                        "label": $scope.i18n.app_term_vmMinNum_label + ":",
                        "width": "130px",
                        require: true,
                        "tooltip": UnifyValid.validateInfo.maximumSize,
                    ...
                    "desiredCapacity": {
                        ...
                        "label": $scope.i18n.app_term_vmRunMinNum_label + ":",
                        "width": "130px",
                        require: true,
                    ...
                    "scalingPolicies": {
                        "label": $scope.i18n.app_term_intraPolicy_label || "组内策略"
                    },
            ...
            $scope.info = {
                "designerPage": "app/business/multiPool/views/appTemplate/designer/layout/designerCell.html",
                "designerShow": true,
                "templatePage": "app/business/multiPool/views/appTemplate/designer/layout/templateCell.html",
                "templateShow": false,
                "networkPage": "app/business/multiPool/views/appTemplate/designer/layout/networkCell.html",
                "networkShow": false,
                "scriptPage": "app/business/multiPool/views/appTemplate/designer/layout/scriptCell.html",
                "scriptShow": false,
                "softwarePage": "app/business/multiPool/views/appTemplate/designer/layout/softwareCell.html",
                "softwareShow": false,
                "nicToTempPage": "app/business/multiPool/views/appTemplate/designer/layout/nicToTemplateCell.html",
                "nicToTempShow": false,
                "backBtn": {
                ...
                "validateBtn": {
                    ...
                    "text": $scope.i18n.app_term_checkout_button || "校验",
                    "click": function () {
                        $scope.graph.template.generateResourceGraph($scope.graph);
                        ...
                        deferred.then(function (data) {
                            message.okMsgBox($scope.i18n.app_term_templateCheckSucceed_msg || "应用模板校验成功.");
                        });
                    }
                }
            };
            $scope.$watch("designerCell.value.name", function (newV, oldV) {
                ...
                $scope.graph.template.properties.name = name;
            ...
            CoreGraph.prototype._selectCellHandle = function (sender, evt) {
                ...
                if (this.getSelectionCount() !== 1) {
                    ...
                    $scope.designerCell.value = {
                        name: this.template.properties["name"],
                ...
                if (cell.isVertex()) {
                    ...
                    if (type === "VmTemplate" || type === "ScalingGroup") {
                        ...
                        $scope.$watch("templateCell.value.name", mxUtils.bind(this, function (newV, oldV) {
                            var name = newV;
                            if (/^\s*[\u4E00-\u9FA5-a-zA-Z_0-9]*(\s)*$/.test(name) && name.length > 1 && name.length < 256) {
                        ...
                        if ($scope.isScallingGroup) {
                            ...
                            $scope.$watch("templateCell.scalinggroup.value.name", mxUtils.bind(this, function (newV, oldV) {
                                var name = $.trim(newV);
                                if (!/^\s*[\w\s\._\-\(\)\[\]\#\u4E00-\u9FA5]*$/.test(name) || name.length < 1 || name.length > 256) {
                                    return false;
                                }
            ...
            $scope.addScalingPolicyUI = function (type, scalingPolicyId) {
                ...
                var title = (type === "create" ? $scope.i18n.app_term_addIntraPolicy_button : $scope.i18n.app_term_modifyIntraPolicy_button);
                ...
                var options = {
                    ...
                    "content": "app/business/multiPool/views/appTemplate/designer/layout/scalingPolicy.html",
                    "buttons": null
                };
            ...
            function getVMTransplantType(transplantType) {
                var values = [{
                    ...
                    "selectId": "support",
                    "label": $scope.i18n.common_term_support_value,
